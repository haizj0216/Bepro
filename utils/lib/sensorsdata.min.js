...
function e(r) {
    return (e = "function" == typeof Symbol && "symbol" === (0, t.default)(Symbol.iterator) ? function (e) {
...
var a = Array.prototype,
    ...
    u = o.toString,
    p = o.hasOwnProperty,
    f = "utm_source utm_medium utm_campaign utm_content utm_term",
    h = {
...
n.lib_version = "1.13.6",
    function () {
        ...
        var t = a.forEach,
            ...
            n = Array.isArray,
            o = {},
            f = r.each = function (e, r, n) {
                if (null == e) return !1;
                if (t && e.forEach === t) e.forEach(r, n);
                else if (e.length === +e.length) {
                    for (var i = 0, a = e.length; i < a; i++)
                        if (i in e && r.call(n, e[i], i, e) === o) return !1;
                } else
                    for (var s in e)
                        if (p.call(e, s) && r.call(n, e[s], s, e) === o) return !1;
            };
        ...
        var e, n, i, a, s, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
            c = 0,
            u = 0,
            p = "",
            f = [];
        ...
        return null === n || n && "string" != typeof n[1] && n[1].length ? "" : r.decodeURIComponent(n[1]);
    }, n.initialState = {
        queue: [],
        isComplete: !1,
        systemIsComplete: !1,
    ...
    }, r.getPrefixUtm = function (t, e, n) {
        if (e = e || "", n = n || "_", !r.isObject(t)) return {};
        var i = {},
            a = {};
        for (var s in t) - 1 !== (" " + f + " ").indexOf(" " + s + " ") ? i[e + s] = t[s] : a[n + s] = t[s];
        return {
            $utms: i,
            otherUtms: a
        };
    }, r.convertObjToParam = function (t) {
        var e = [];
        for (var r in t) e.push(r + "=" + t[r]);
        return e.join("&");
    }, r.getSource = function (t) {
        if (r.isObject(t)) {
            if (r.isEmptyObject(t)) return {};
            for (var e in t) - 1 === (" " + f + " ").indexOf(" " + e + " ") ? delete t[e] : t[e] = t[e].replace("?", "*");
            t = "?" + (t = r.convertObjToParam(t));
        } else t = r.decodeURIComponent(t);
        var i = f.split(" "),
            a = f.split(" "),
            s = "",
            o = {};
        return 2 !== (t = t.split("?")).length ? {} : (t = "?" + (t = t[1]), r.isArray(n.para.source_channel) && n.para.source_channel.length > 0 && (a = a.concat(n.para.source_channel),
            a = r.unique(a)), r.each(a, function (e) {
            s = r.getQueryParam(t, e), (s = r.decodeURIComponent(s)).length && r.include(i, e) && (o[e] = s);
        }), o);
        ...
        return e;
    }, r.getUtm = function (t, e, n) {
        var i = r.getSource(t);
        return void 0 === n && e ? {
            pre1: r.getPrefixUtm(i, e).$utms || {},
            pre2: {}
        } : void 0 !== n && e ? {
            pre1: r.getPrefixUtm(i, e).$utms || {},
            pre2: r.getPrefixUtm(i, n).$utms || {}
        } : {
            pre1: {},
            pre2: {}
        };
        ...
        if ("number" == typeof g && 0 !== g) {
            var t = n.store.getDistinctId(),
                e = n.store.getFirstId();
            return !m || m !== t && m !== e ? g + 1 : g;
        }
        return 1;
        ...
        var i = (n = JSON.parse(n)).d,
            a = n.p,
            s = n.i;
        "string" == typeof s ? (e.$share_distinct_id = s, m = s) : e.$share_distinct_id = "取值异常",
            "number" == typeof i ? (e.$share_depth = i, g = i) : e.$share_depth = "-1", e.$share_url_path = "string" == typeof a ? a : "取值异常";
        ...
        var n = {};
        if (t && r.isObject(t.query)) {
            var i = (n = r.extend({}, t.query)).scene;
            i && (i = -1 !== (i = r.decodeURIComponent(i)).indexOf("?") ? "?" + i.replace(/\?/g, "") : "?" + i,
                r.extend(n, r.getObjFromQuery(i))), t.query.q && r.extend(n, r.getObjFromQuery(r.decodeURIComponent(t.query.q)));
        }
        if (t && r.isObject(t.referrerInfo) && t.referrerInfo.extraData) {
            var a = {};
            r.isObject(t.referrerInfo.extraData) && !r.isEmptyObject(t.referrerInfo.extraData) ? a = t.referrerInfo.extraData : r.isJSONString(t.referrerInfo.extraData) && (a = JSON.parse(t.referrerInfo.extraData)),
                r.extend(n, a);
        }
        var s = r.getUtm(n, "$", "$latest_");
        return r.extend(e, s.pre1), s;
        ...
        set: function (t, r) {
            var n = {};
            for (var i in "string" == typeof t ? n[t] = r : "object" == e(t) && (n = t), this._state = this._state || {},
                    n) this._state[i] = n[i];
            this.save();
        },
        change: function (t, e) {
        ...
        if ("string" != typeof t && "number" != typeof t) return !1;
        t = n.store.verifyDistinctId(t);
        var e = n.store.getFirstId(),
            r = n.store.getDistinctId();
        ...
        appLaunch: function (t, i) {
            ...
            var s = r.setUtm(t, a);
            _ ? (a.$is_first_time = !0, r.isEmptyObject(s.pre1) || n.setOnceProfile(s.pre1)) : a.$is_first_time = !1,
        ...
        appShow: function (t, e) {
            var i = {};
            l = new Date().getTime(), t && t.path && (i.$url_path = r.getPath(t.path)), r.setShareInfo(t, i);
            var a = r.setUtm(t, i);
        ...
        appHide: function (t) {
            var e = new Date().getTime(),
                i = {};
            i.$url_path = r.getCurrentPath(), l && e - l > 0 && (e - l) / 36e5 < 24 && (i.event_duration = (e - l) / 1e3),
        ...
        pageShow: function (t) {
            var e = {},
                i = r.getCurrentPath();
            e.$referrer = d, e.$url_path = i, n.status.last_referrer = d, this.sensors_mp_url_query && (e.$url_query = this.sensors_mp_url_query),
                t ? (e = r.extend(e, t), n.track("$MPViewScreen", e)) : n.para.onshow ? n.para.onshow(n, i, this) : n.para.autoTrack && n.para.autoTrack.pageShow && n.autoTrackCustom.trackCustom("pageShow", e, "$MPViewScreen"),
                d = i, n.status.referrer = i;
        },
        pageShare: function (t, i) {
            ...
            t.onShareAppMessage = function () {
                ...
                }, "$MPShare"), n.para.allow_amend_share_path && ("object" != e(t) && ((t = {}).path = r.getCurrentUrl(this)),
                    "object" != e(t) || void 0 !== t.path && "" !== t.path || (t.path = r.getCurrentUrl(this)),
                    "object" == e(t) && "string" == typeof t.path && (-1 === t.path.indexOf("?") ? t.path = t.path + "?" : "&" !== t.path.slice(-1) && (t.path = t.path + "&")),
...
App = function (t) {
    y(t, "onLaunch", "appLaunch"), y(t, "onShow", "appShow"), y(t, "onHide", "appHide"),
...
Page = function (t) {
    y(t, "onLoad", "pageLoad"), y(t, "onShow", "pageShow"), "function" == typeof t.onShareAppMessage && n.autoTrackCustom.pageShare(t),
        S.apply(this, arguments);
};
...
Component = function (t) {
    try {
        var e = t.methods || {};
        y(e, "onLoad", "pageLoad"), y(e, "onShow", "pageShow"), "function" == typeof e.onShareAppMessage && n.autoTrackCustom.pageShare(t.methods),
